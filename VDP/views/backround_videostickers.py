...
base_path = 'media/videostickers/'
base_url = 'https://s1.v100.vip:5728/api/media/videostickers/'

class SystemVideoSticker(ModelViewSet):
...
class CustomVideoSticker(ModelViewSet):
