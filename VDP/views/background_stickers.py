...
base_path = 'media/stickers/'
base_url = 'https://s1.v100.vip:5728/api/media/stickers/'

class SystemBackgroundSticker(ModelViewSet):
...
class CustomBackgroundSticker(ModelViewSet):
